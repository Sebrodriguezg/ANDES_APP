...
\end{tabular}}
\newpage
\seccion{Semana 1 \quad\textnormal{\normalsize 17 de agosto -- 23 de agosto}}
\textbf{Foco:} Diagnóstico y cinemática\\[0.5mm]
\textbf{Por qué:} Medir dónde estás realmente y reactivar Física 1. Sin este número el resto del plan va a ciegas.\\[0.5mm]
\textbf{Entregable de la semana:} Diagnóstico registrado con \texttt{medidor.py simulacro} y reporte generado.
\par\vspace{2.5mm}
...
\ch & \textbf{Lunes 17} & 16:00 & \ch & Simulacro diagnóstico, preguntas 1--12. Cronómetro de 60 min, sin apuntes, sin calculadora. Archivo: 01\_EXAMENES/uniandes\_admision/ & \ch & Sigue con las preguntas 13--24 (otros 60 min). Terminas el diagnóstico hoy.\\
\rowcolor{gris2}
\ch & \textbf{Martes 18} & 16:00 & \ch & Si ayer solo hiciste 1--12: resuelve 13--24 en 60 min. Si ya terminaste: corrígelo con 03\_TEMARIO/00\_mapa\_simulacro.md. & \ch & Además: regístralo con \texttt{python3 06\_SEGUIMIENTO/medidor.py simulacro}.\\
...
\rowcolor{libre}
 & \textbf{Sábado 22} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 29} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 5} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 12} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 19} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 26} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 3} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 10} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 17} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 24} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 31} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 7} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 14} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
...
\rowcolor{libre}
 & \textbf{Sábado 21} & --- & \multicolumn{4}{l@{}}{\textit{Libre. Sin asignación en todo el plan.}}\\
\rowcolor{gris}
