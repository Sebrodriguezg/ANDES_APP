...
{\large\textbf{Del viernes 14 de agosto al domingo 22 de noviembre de 2026} \quad ---\quad 14 semanas, S0 a S13}\\[2mm]
...
\hline
\rowcolor{cab}\color{white}\textbf{\ Habilidad} & \color{white}\scriptsize\textbf{S0} & \color{white}\scriptsize\textbf{S1} & \color{white}\scriptsize\textbf{S2} & \color{white}\scriptsize\textbf{S3} & \color{white}\scriptsize\textbf{S4} & \color{white}\scriptsize\textbf{S5} & \color{white}\scriptsize\textbf{S6} & \color{white}\scriptsize\textbf{S7} & \color{white}\scriptsize\textbf{S8} & \color{white}\scriptsize\textbf{S9} & \color{white}\scriptsize\textbf{S10} & \color{white}\scriptsize\textbf{S11} & \color{white}\scriptsize\textbf{S12} & \color{white}\scriptsize\textbf{S13}\\ \hline
...
\end{tabular}}
\newpage
\seccion{S0 \quad\textnormal{\normalsize 14 de agosto -- 23 de agosto}}
...
\textbf{Entregable de la semana:} 04\_ESTUDIO/formularios/mecanica\_analitica.md con los 3 patrones + 3 tarjetas Anki. \textbf{No pases a S4 sin esto.}
\par\vspace{2.5mm}
\noindent\begin{tabular}{@{}p{0.45cm}p{2.5cm}p{1.05cm}|p{0.45cm}p{9.75cm}|p{0.45cm}p{9.75cm}@{}}
\rowcolor{cab}
\multicolumn{3}{@{}l}{\color{white}\textbf{\ Día}} & \multicolumn{2}{l}{\color{white}\textbf{MÍNIMA --- 1 hora}} & \multicolumn{2}{l}{\color{white}\textbf{EXTENDIDA --- 2 horas (la mínima + esto)}}\\
...
\rowcolor{gris}
\ch & \textbf{Domingo 11} & libre & \multicolumn{4}{l@{}}{\textit{Comodín. \textbf{Corte de control:} corre \texttt{medidor.py reporte} y lee las recomendaciones. Si algún área va bajo 55\,\%, róbale sesiones a óptica (S11).}}\\
\end{tabular}
\vspace{2mm}
...
\end{itemize}
\textbf{Tenlos listos antes del 31 de octubre.} Las referencias dependen de terceros: pídelas en S8.
\vspace{2mm}

\seccion{Entregables por semana}
\begin{tabular}{@{}p{1.3cm}p{11cm}@{}}
S0 & \ch\ Diagnóstico corregido y registrado: mapa de fortalezas y debilidades\\
S1 & \ch\ Formulario mecánica I + 60 problemas\\
S2 & \ch\ Formulario mecánica II + 60 problemas (amplitud del forzado, memorizada)\\
S3 & \ch\ Formulario mecánica analítica + patrones 1--3 + 40 problemas\\
S4 & \ch\ Formulario electrostática + 60 problemas\\
S5 & \ch\ Formulario magnetostática e inducción + 60 problemas\\
S6 & \ch\ Formulario Maxwell/gauge/ondas y relatividad + patrones 4--5\\
S7 & \ch\ Formulario termodinámica + 50 problemas + corte de control\\
S8 & \ch\ Formulario estadística + patrones 6--8 + referencias pedidas\\
S9 & \ch\ Formulario moderna + patrón 9 + carta de intención\\
S10 & \ch\ Formulario cuántica + patrón 10 + 50 problemas\\
S11 & \ch\ Formulario óptica y ondas + repaso transversal\\
S12 & \ch\ Simulacros 1--3 cronometrados + análisis de error\\
S13 & \ch\ Repaso de errores + simulacros 4 y 5 + inscripción cerrada\\
\end{tabular}
\end{minipage}
